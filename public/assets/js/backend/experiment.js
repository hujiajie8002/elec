define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'experiment/index' + location.search,
                    add_url: 'experiment/add',
                    edit_url: 'experiment/edit',
                    del_url: 'experiment/del',
                    multi_url: 'experiment/multi',
                    import_url: 'experiment/import',
                    table: 'experiment',
                }
            });
