define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'dky_device/index' + location.search,
                    add_url: 'dky_device/add',
                    edit_url: 'dky_device/edit',
                    del_url: 'dky_device/del',
                    multi_url: 'dky_device/multi',
                    import_url: 'dky_device/import',
                    table: 'dky_device',
                    //fastadmin中的表格传参
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'jljzdw', title: __('Jljzdw'), operate: 'LIKE'},
                        {field: 'experiment_ids', title: __('Experiment_ids'), operate: 'LIKE'},
                        {field: 'principal', title: __('Principal'), operate: 'LIKE'},
                        {field: 'zsyxq', title: __('Zsyxq'), operate:'RANGE', addclass:'datetimerange', autocomplete:false},
                        {field: 'clfw', title: __('Clfw'), operate: 'LIKE'},
                        {field: 'clbqdd', title: __('Clbqdd'), operate: 'LIKE'},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'dky_device/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
