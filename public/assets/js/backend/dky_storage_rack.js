define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'dky_storage_rack/index' + location.search,
                    add_url: 'dky_storage_rack/add',
                    edit_url: 'dky_storage_rack/edit',
                    del_url: 'dky_storage_rack/del',
                    multi_url: 'dky_storage_rack/multi',
                    import_url: 'dky_storage_rack/import',
                    table: 'dky_storage_rack',
                    //fastadmin中的表格传参
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'dky_storage_rack/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
