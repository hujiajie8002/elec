...
class Backend extends Controller
{
    ...
    protected function buildparams($searchfields = null, $relationSearch = null)
    {
        ...
        $offset = $this->request->get("offset/d", 0,'addslashes,htmlspecialchars');
        $limit = $this->request->get("limit/d", 100,'addslashes,htmlspecialchars');
        //新增自动计算页码
    ...
    protected function selectpage()
    {
        ...
        if ($total > 0) {
            ...
            if (($username == 'snfzx' || $username == 'szfzx' || $username == 'sbfzx') && in_array($baseUrl,$arr2)){
