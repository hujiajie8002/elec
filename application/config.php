...
return [
    ...
    // 默认全局过滤方法 用逗号分隔多个
    'default_filter'         => 'addslashes,trim,htmlspecialchars,strip_tags,xss_clean',
    // 默认语言
    'default_lang'           => 'zh-cn',
    // 应用类库后缀
    'class_suffix'           => false,
    ...
    'log'                    => [
        ...
        // 日志记录级别
     //   'level' => ['error','sql'],
        'apart_level' => ['error','sql','debug','log','notice'],
    ],
    // +----------------------------------------------------------------------
    ...
    //redis配置
    'redis'=>array(
        'ip'=>Env::get('redis.ip', false),
        'port'=>Env::get('redis.port', false),
        'fh'=>Env::get('redis.fh', false),
    ),
];
